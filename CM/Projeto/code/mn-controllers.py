...
def main():
    net = Mininet(topo=TopoExample(), switch=OVSSwitch, cleanup=True, controller=None)
    net.addController('c1', controller=RemoteController, ip='localhost', port=6653, protocols="OpenFlow13")
    net.addController('c2', controller=RemoteController, ip='localhost', port=6633, protocols="OpenFlow13")
