...
import commInfra.EndOfTransactionException;
...
public class KnockKnockProtocol
{
    ...
    */
    ...
    public String processInput (String theInput) throws EndOfTransactionException
    {
                              ...
                              if (theInput.equalsIgnoreCase ("y"))
                                 { theOutput = "Knock! Knock!";
                                   state = SENTKNOCKKNOCK;
                                        ...
                                        throw new EndOfTransactionException ("Bye.");
                                      }
       }
       return theOutput;
    }
