...
public class AssaultParty
{
     ...
     */
    public AssaultParty (int assaultPartyId, int targetRoomId, GeneralRepos repos)
    {
        this.repos = repos;
    ...
    public synchronized void crawlIn ()
    {
        ...
        while (true) {
            ...
            while ((displacement = canICrawl(thiefIndex)) != -1) {
                ...
                repos.setOrdinaryThiefPos(thief.getOrdinaryThiefId(), ordinaryThievesPos[thiefIndex]);
            }
    ...
    public synchronized void sendAssaultParty ()
    {
        ...
        repos.setMasterThiefState(masterThief.getMasterThiefState());
    ...
    public void leaveTheAssaultParty (int thiefId)
    {
        ...
        repos.setAssaultPartyThievesId(thiefId, -1);
    }
