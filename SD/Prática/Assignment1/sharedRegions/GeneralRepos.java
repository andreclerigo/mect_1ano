...
public class GeneralRepos
{
     ...
     */
    public GeneralRepos (String logFileName, int [] roomDistance, int [] nCanvasInRoom, int [] ordinaryThiefAgility)
    {
        ...
        this.nCanvasInRoom = nCanvasInRoom;
        canvasResult = 0;
    ...
    public synchronized void setOrdinaryThiefState (int id, int state)
    {
        ...
        //log.writelnString("Debug of the method setOrdinaryThiefState:");
        ...
        // if the id of the thief is in the first 3 spots of the array assault, it means that it is in the assault party 0
     ...
     *     @param canvas
     */
    public synchronized void giveCanvas (int id, boolean canvas)
    {
        if (canvas){
            bringsCanvas[id] = 1;
        } else {
