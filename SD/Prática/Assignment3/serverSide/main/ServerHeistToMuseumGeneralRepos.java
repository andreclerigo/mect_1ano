...
public class ServerHeistToMuseumGeneralRepos
{
   ...
   */
   public static void main(String[] args)
   {
     ...
     /* wait for the end of operations */
      ...
      try
      { while (!end)
          synchronized (Class.forName ("serverSide.main.ServerHeistToMuseumGeneralRepos"))
          { try
            { (Class.forName ("serverSide.main.ServerHeistToMuseumGeneralRepos")).wait ();
            }
      ...
      { GenericIO.writelnString ("The data type ServerHeistToMuseumGeneralRepos was not found (blocking)!");
        e.printStackTrace ();
        System.exit (1);
      }
   ...
   */
   ...
   public static void shutdown ()
   {
      ...
      try
      { synchronized (Class.forName ("serverSide.main.ServerHeistToMuseumGeneralRepos"))
        { (Class.forName ("serverSide.main.ServerHeistToMuseumGeneralRepos")).notify ();
        }
      }
     catch (ClassNotFoundException e)
     { GenericIO.writelnString ("The data type ServerHeistToMuseumGeneralRepos was not found (waking up)!");
       e.printStackTrace ();
       System.exit (1);
     }
   }
