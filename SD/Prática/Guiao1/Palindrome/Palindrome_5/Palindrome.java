...
/**
 *    Palindrome detection using a stack and a FIFO derived both from a parametric memory for temporary storage.
 *    Java Generics are put to work.
 *    Errors are reported.
 */
   ...
   public static void main (String [] args)
   {
    ...
    /* reading the word from the keyboard */
     ...
     { int i = 0;                                          // counting variable
       ...
       MemStack<Character> stack = new MemStack<> (new Character [word.length ()]);     // stack instantiation
       MemFIFO<Character> fifo = new MemFIFO<> (new Character [word.length ()]);        // FIFO instantiation
