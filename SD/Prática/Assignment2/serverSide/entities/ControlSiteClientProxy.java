...
import serverSide.sharedRegions.ControlSiteInterface;

/**
 *   Service provider agent for access to the Control Site.
 *   Implementation of a client-server model of type 2 (server replication).
 *   Communication is based on a communication channel under the TCP protocol.
 */
public class ControlSiteClientProxy extends Thread implements MasterThiefCloning, OrdinaryThiefCloning
{
    /**
     ...
     */
    private ControlSiteInterface controlSiteInter;
     ...
     *     @param controlSite interface to the control site
     */
    public ControlSiteClientProxy (ServerCom sconi, ControlSiteInterface controlSite)
    {
        super ("ControlSiteProxy_" + ControlSiteClientProxy.getProxyId());
        this.sconi = sconi;
        this.controlSiteInter = controlSite;
    }
    ...
    private static int getProxyId ()
    {
        ...
        try {
            ...
            System.out.println("Data type ControlSiteClientProxy was not found!");
            e.printStackTrace ();
            System.exit(1);
        }
    ...
    public void run ()
    {
        ...
        try {
            outMessage = controlSiteInter.processAndReply(inMessage);   // process it
